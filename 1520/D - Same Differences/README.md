...
6
1 6 3 4 5 6
</pre></div><div class="output"><div class="title">Output<div title="Copy" data-clipboard-target="#id009768005660403812" id="id005151349016267913" class="input-output-copier">Copy</div></div><pre id="id009768005660403812">1
3
3
10
</pre></div></div></div>